...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Smart Health Care</strong></a>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
                  <li><a href="Users/login.php">Patient</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location/chennai.html">Chennai</a></li>
        </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pic/index1.jpg" alt="img1" width="1200" height="700">

      </div>

      <div class="item">
        <img src="pic/index2.jpg" alt="img2" width="1200" height="700">
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center">Smart Health Care</h3>
  <p class="text-center"><em>Virtual healthcare  means online patient care!</em></p>
    <p class="text-center"> Our highly specialized experts are deeply experienced in treating rare and complex conditions . You can get appointment from here . For getting appointment at first you need to login at this site . <br> You can still get locations about other nearest hospitals from here.
 </p>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Chennai, Tamil Nadu, India<br>
        <i class="fa fa-phone" style="width:30px"></i> <a href="tel:8778315879">8778315879</a><br>
        <i class="fa fa-envelope" style="width:30px"> </i> <a href="mailto:admin@gmail.com">admin@gmail.com</a><br>
      </div>
      <?php
